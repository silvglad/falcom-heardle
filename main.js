var app = (function () {
        ...
        (u = new Bt({})),
        {
          c() {
            (n = w("p")),
              (s = w("p")),
              (n.textContent =
                "Creator is @susatoss on Twitter (using credited templated)! I only added a few Ys and Trails songs but if this actually manages to find its way to the Falcom fandom, I'll probably add more! If you have any suggestions for tracks, hit me up on Twitter!"),
              (r = x()),
              (s = w("p")),
              // (s.innerHTML =
        ...
        (O = new Rt({})),
        {
          c() {
            ...
            (o = x()),
              ...
              (m = w("div")),
              (k = w("div")),
              (k.textContent = "Next Falcom song in:"),
              (b = x()),
              Q(S.$$.fragment),
              (D = x()),
              (T = w("div")),
    ...
    function an(e) {
      ...
      return {
        c() {
          (t = _("You got today's Falcom Heardle within the first ")),
            (n = _(s)),
            (r = _(" seconds."));
        },
        m(e, s) {
    ...
    function ln(e) {
      ...
      return {
        c() {
          (t = _("You got today's Falcom Heardle within ")),
            (n = _(o)),
            (r = _("\n                second")),
            (s = _(a)),
            (i = _("."));
    ...
    function un(t) {
      ...
      return {
        c() {
          n = _(
            "You didn't get today's Falcom Heardle. Better luck tomorrow! 💎"
          );
        },
        m(e, t) {
          g(e, n, t);
      ...
      return (
        ...
        [
          ...
          () => {
            ...
            let e = "Falcom Heardle #" + (s.id + 1),
              t = "";
            let hhh =
              "Put your skills to the test at https://falcom-heardle.glitch.me";
            a
    ...
    const Cn = ue([
        ...
        "Ys I&II Chronicles - Over Drive",
        "Falcom vs. jdk BAND 2010 Summer - Crossing Rage! (Ys Seven)",
        "Zero no Kiseki - Get Over The Barrier!",
        "Ys I&II Chronicles - To Make the End of Battle −Long Version−",
        "Sen no Kiseki II - Blue Destination",
        "Ys: The Oath in Felghana - Valestein Castle",
        "Sora no Kiseki Zanmai - Sophisticated Fight (Sora no Kiseki FC)",
        "Ys: Foliage Ocean in Celceta - Burning Sword (Ys IV)",
        "Ao no Kiseki - The Azure Arbitrator",
        "Ys IX Monstrum NOX - Knock on NOX",
        "Sora no Kiseki the 3rd - Overdosing Heavenly Bliss",
        "Gurumin - Soaring Through Azure Sadness",
        "Ys Origin - Feena",
        "Tokyo Xanadu - Hazy Moon",
        "Ys VIII Lacrimosa of DANA - Lacrimosa of DANA",
        "Sen no Kiseki IV - To the future",
        "Zwei!! - Mythical Land Serpentina",
        "Ys vs. Sora no Kiseki: Alternative Saga - D.A.Y./BREAK",
        "Sora no Kiseki the 3rd - Cry for your Eternity",
        "Ys VI The Ark Of Napishtim - Ernst",
        "Sora no Kiseki SC - Fateful Confrontation",
        "Ys Origin - Genesis Beyond the Beginning",
        "Ys VIII Lacrimosa of DANA - A to Z",
        "Zero no Kiseki Super Arrange Version - Inevitable Struggle",
        "Ys: The Oath in Felghana - Chop!!",
        "Kuro no Kiseki - Hard Desperation (Boss Theme 1)",
        "Ys IX Super Ultimate - Glessing Way!!",
        "Ys Seven - Smashing Through the Mountain Path",
        "Sen no Kiseki III - Step Ahead (Boss Theme 4)",
        "Ys Seven - Legend of the Five Great Dragons",
        "Ys IX Monstrum NOX - Desert After Tears",
        "Sen no Kiseki - The Decisive Collision",
        "Sora no Kiseki FC - Hollow Light of the Sealed Land",
        "Ys: Foliage Ocean in Celceta - Black Wings",
        "Sen no Kiseki - The Glint of Cold Steel",
        "Ys: Foliage Ocean in Celceta - The Morning After the Storm",
        "Sora no Kiseki FC - Hoshi no Arika Full Version",
        "Ys VI: The Ark of Napishtim - Release of the Far West Ocean",
        "Ao no Kiseki Evolution - Unfathomed Force",
        "Ys Origin Super Arrange Version - Scars of the Divine Wing",
        "Sen no Kiseki III - Spiral of Erebos (Final Dungeon Theme)",
        "Ys: The Oath in Felghana - The Boy's Got Wings",
        "Sora No Kiseki SC - The Fate Of The Fairies",
        "Sora no Kiseki Vocal Version - Maybe it was fated (Sora no Kiseki SC)",
        "Ys I&II Chronicles - First Step Towards Wars",
               "Sen no Kiseki IV - Burning Throb",
               "Ys VIII Lacrimosa of DANA - Yesterday in Etania",
               "Sen no Kiseki - Don't Be Defeated By A Friend!",
               "Sen no Kiseki III - Brave Steel",
               "Ys: The Oath in Felghana - Dear My Brother",
               "Ys: Foliage Ocean in Celceta - The False God of Causality",
               "Sen no Kiseki - Tie A Link Of ARCUS!",
               "Ys VIII Lacrimosa of DANA - Next Step Towards the Unknown",
               "Sen no Kiseki IV - Mighty Urge",
            "Ys IX Monstrum NOX - Norse Wind",
        "Ys IX Monstrum NOX - Cloaca Maxima",
               "Ys: The Oath in Felghana - The Strongest Foe",
               "Sora no Kiseki FC - Disappearing Star",
               "Ys VI: The Ark of Napishtim - Mighty Obstacle",
               "Ys VIII Lacrimosa of DANA - Lost in Green",
               "Sora no Kiseki FC - A Cat Relaxing in the Sun",
            "Ys Seven - Innocent Primal Breaker",
        "Ys Seven - Tia",
               "Ys: The Oath in Felghana - A Searing Struggle",
               "Sora no Kiseki the 3rd - Fighting Right On",
               "Ys VIII Lacrimosa of DANA - Dana",
               "Sen no Kiseki IV - Seductive Shudder",
               "Ys: Foliage Ocean in Celceta - Adventurer's Birth",
               "Ys VIII Lacrimosa of DANA - Gens D'Armes",
               "Sora no Kiseki SC - The Merciless Savior",
               "Ys VIII Lacrimosa of DANA - Overcome the Rocky Path",
               "Ys: The Oath in Felghana - Sealed Time",
               "Sora no Kiseki SC - Silver Will, Golden Wings",
               "Ys VI: The Ark of Napishtim - Zemeth Sanctum",
                "Ys Origin Super Arrange Version - Scarlet Tempest",
               "Zero no Kiseki - Formidable Enemy (Super Arrange)",
               "Ys: Foliage Ocean in Celceta - Ancient Land",
               "Ys VIII Lacrimosa of DANA - Eroded Valley",
               "Sora no Kiseki FC - A Cat Relaxing in the Sun",
               "Ys VI: The Ark of Napishtim - Quatera Woods",
               "Sora no Kiseki SC - Back to Our Friends",
               "Ys: The Oath in Felghana - A Premonition =Styx=",
               "Ys VIII Lacrimosa of DANA - Crimson Fighter",
               "Sora no Kiseki SC - The Enforcers (Super Arrange)",
                    "Ys Origin - Termination",
               "Ys: Foliage Ocean in Celceta - The Dawn of Ys",
               "Sora no Kiseki SC - I Swear",
               "Ys VI: The Ark of Napishtim - The Ruined City of Kishgal",
               "Ys: The Oath in Felghana - Be Careful",
               "Sen no Kiseki - Belief",
                    "Ys Origin - Overdrive",
               "Ys VIII Lacrimosa of DANA - A Footprint in the Wet Sand",
               "Sora no Kiseki the 3rd - Determination of Fight",
               "Ys VIII Lacrimosa of DANA - Hope Alive",
               "Sora no Kiseki FC - The Byway of Departure",
               "Ys: Foliage Ocean in Celceta - The Foliage Ocean in Celceta",
               "Ys: The Oath in Felghana - The Theme of Chester",
               "Sen no Kiseki - To Become The Foundation Of An Era",
      ...
      On = {
        subscribe: ue(
          [
            {
              url: "https://soundcloud.com/user-790251991/sunshine-coastline",
              answer: "Ys VIII Lacrimosa of DANA - Sunshine Coastline",
            },
            {
              url: "https://soundcloud.com/insaneythepresequel/trails-in-the-sky-super-arrange-silver-will",
              answer: "Sora no Kiseki FC & SC Super Arrange Version - Silver Will",
            },
            {
              url: "https://soundcloud.com/double-dooped-08/y2mate-com-2",
              answer: "Ys I&II Chronicles - Over Drive",
            },
            {
              url: "https://soundcloud.com/swaditsforroll20again/crossing-rage-falcom-vs-jdk-band-ver-ys-seven-high-quality-1080p-hd",
              answer: "Falcom vs. jdk BAND 2010 Summer - Crossing Rage! (Ys Seven)",
            },
            {
              url: "https://soundcloud.com/rina-281211575/get-over-the-barrier",
              answer: "Zero no Kiseki - Get Over The Barrier!",
            },
            {
              url: "https://soundcloud.com/user-363225968/to-make-the-end-of-battle",
              answer: "Ys I&II Chronicles - To Make the End of Battle −Long Version−",
            },
            {
              url: "https://soundcloud.com/ovys9kfczsly/blue-destination",
              answer: "Sen no Kiseki II - Blue Destination",
            },
            {
              url: "https://soundcloud.com/imc1-1/ys-the-oath-in-felghana",
              answer: "Ys: The Oath in Felghana - Valestein Castle",
            },
                      {
              url: "https://soundcloud.com/swadthegreatbando/sora-no-kiseki-zanmai-02-sophisticated-fight",
              answer: "Sora no Kiseki Zanmai - Sophisticated Fight (Sora no Kiseki FC)",
            },
            {
              url: "https://soundcloud.com/user-353722231/burning-sword",
              answer: "Ys: Foliage Ocean in Celceta - Burning Sword (Ys IV)",
            },
            {
              url: "https://soundcloud.com/phx-454233393/the-azure-arbitrator-ed",
              answer: "Ao no Kiseki - The Azure Arbitrator",
            },
            {
              url: "https://soundcloud.com/biscoto-theo/ys-ix-14-knock-on-nox",
              answer: "Ys IX Monstrum NOX - Knock on NOX",
            },
            {
              url: "https://soundcloud.com/user-832935549-194119192/overdosing-heavenly-blissjdkcopyright-nihon-falcom-corporation",
              answer: "Sora no Kiseki the 3rd - Overdosing Heavenly Bliss",
            },
                      {
              url: "https://soundcloud.com/bmkfuzz/gurumin-ost-soaring-through-azure-sadness",
              answer: "Gurumin - Soaring Through Azure Sadness",
            },
            {
              url: "https://soundcloud.com/user-570864960/ys-origin-feena",
              answer: "Ys Origin - Feena",
            },
            {
              url: "https://soundcloud.com/user-123394940/tokyo-xanadu-ost-hazy-moon",
              answer: "Tokyo Xanadu - Hazy Moon",
            },
            {
              url: "https://soundcloud.com/user-790251991/lacrimosa-of-dana?in=user-790251991/sets/ys-viii-lacrimosa-of-dana-ost",
              answer: "Ys VIII Lacrimosa of DANA - Lacrimosa of DANA",
            },
            {
              url: "https://soundcloud.com/paper-goat/sen-no-kiseki-iv-trails-of-cold-steel-iv-final-dungeon-theme",
              answer: "Sen no Kiseki IV - To the future",
            },
            {
              url: "https://soundcloud.com/pasokon-deacon/mythical-land-serpentina-sc-88pro",
              answer: "Zwei!! - Mythical Land Serpentina",
            },
                                {
              url: "https://soundcloud.com/user-549347973/day-break",
              answer: "Ys vs. Sora no Kiseki: Alternative Saga - D.A.Y./BREAK",
            },
                      {
              url: "https://soundcloud.com/shiny-cobalion/sora-no-kiseki-the-3rd-ost-cry",
              answer: "Sora no Kiseki the 3rd - Cry for your Eternity",
            },
            {
              url: "https://soundcloud.com/wadfheandos/ys-vi-the-ark-of-napishtim-ost-ernst",
              answer: "Ys VI The Ark Of Napishtim - Ernst",
            },          
                      {
              url: "https://soundcloud.com/eisen-lost/fateful-confrontation",
              answer: "Sora no Kiseki SC - Fateful Confrontation",
            },
                                {
              url: "https://soundcloud.com/user-363225968/genesis-beyond-the-beginning",
              answer: "Ys Origin - Genesis Beyond the Beginning",
            },
            {
              url: "https://soundcloud.com/user-790251991/a-to-z?in=user-790251991/sets/ys-viii-lacrimosa-of-dana-ost",
              answer: "Ys VIII Lacrimosa of DANA - A to Z",
            },
                      {
              url: "https://soundcloud.com/gotat456/inevitable-struggle",
              answer: "Zero no Kiseki Super Arrange Version - Inevitable Struggle",
            },
                                {
              url: "https://soundcloud.com/brolaire_of_asstora/lets-listen-ys-the-oath-in-felghana-chop1",
              answer: "Ys: The Oath in Felghana - Chop!!",
            },
                                          {
              url: "https://soundcloud.com/user-942232914/kuro-no-kiseki-boss-theme-1",
              answer: "Kuro no Kiseki - Hard Desperation (Boss Theme 1)",
            },
            {
              url: "https://soundcloud.com/user-64251720/ys-ix-super-ultimate-glessing",
              answer: "Ys IX Super Ultimate - Glessing Way!!",
            },
                      {
              url: "https://soundcloud.com/orteck/smashing-through-the-mountain-path",
              answer: "Ys Seven - Smashing Through the Mountain Path",
            },
                                {
              url: "https://soundcloud.com/agonynerd/sen-no-kiseki-iii-bgm-rip-step-ahead-boss-theme-4",
              answer: "Sen no Kiseki III - Step Ahead (Boss Theme 4)",
            },
                                {
              url: "https://soundcloud.com/parnash-1/ys-seven-ost-legend-of-the-five-great-dragons",
              answer: "Ys Seven - Legend of the Five Great Dragons",
            },
                                {
              url: "https://soundcloud.com/ra-l-su-rez-130366474/desert-after-tears",
              answer: "Ys IX Monstrum NOX - Desert After Tears",
            },
                                {
              url: "https://soundcloud.com/okaysongs/the-decisive-collision-trails-of-cold-steel-ost",
              answer: "Sen no Kiseki - The Decisive Collision",
            },
                                {
              url: "https://soundcloud.com/ass-mystery/sora-no-kiseki-fc-ost-hollow-light-of-the-sealed-land",
              answer: "Sora no Kiseki FC - Hollow Light of the Sealed Land",
            },
                                {
              url: "https://soundcloud.com/feixin-munoz/black-wings-ys-memories-of",
              answer: "Ys: Foliage Ocean in Celceta - Black Wings",
            },
            {
              url: "https://soundcloud.com/jackie10griffiths/the-glint-of-cold-steel",
              answer: "Sen no Kiseki - The Glint of Cold Steel",
            },
                      {
              url: "https://soundcloud.com/yet-more-gay/ys-memories-of-celceta-the-morning-after-the-storm",
              answer: "Ys: Foliage Ocean in Celceta - The Morning After the Storm",
            },
                                          {
              url: "https://soundcloud.com/mangobroladm8/sora-no-kiseki-fc-ost-hoshi-no-arika-full-version",
              answer: "Sora no Kiseki FC - Hoshi no Arika Full Version",
            },
                                {
              url: "https://soundcloud.com/nobleflare/the-best-of-ys-music-31-release-of-the-far-west-ocean-ys-vi",
              answer: "Ys VI: The Ark of Napishtim - Release of the Far West Ocean",
            },
                                          {
              url: "https://soundcloud.com/sharman-4/aonokisekievolutionost-unfathomedforce",
              answer: "Ao no Kiseki Evolution - Unfathomed Force",
            },
                                          {
              url: "https://soundcloud.com/insaneythepresequel/ys-origin-super-arrange-scars-of-the-divine-wing",
              answer: "Ys Origin Super Arrange Version - Scars of the Divine Wing",
            },
                                                    {
              url: "https://soundcloud.com/user-945662904/spiral-of-erebos",
              answer: "Sen no Kiseki III - Spiral of Erebos (Final Dungeon Theme)",
            },
                                                    {
              url: "https://soundcloud.com/user-363225968/the-boys-got-wings",
              answer: "Ys: The Oath in Felghana - The Boy's Got Wings",
            },
                                                              {
              url: "https://soundcloud.com/kayviel/sora-no-kiseki-sc-ost-the-fate-of-the-fairies",
              answer: "Sora No Kiseki SC - The Fate Of The Fairies",
            },
                                                                        {
              url: "https://soundcloud.com/rina-281211575/maybe-it-was-fated-vocal-version-sora-no-kiseki",
              answer: "Sora no Kiseki Vocal Version - Maybe it was fated (Sora no Kiseki SC)",
            },
                                                              {
              url: "https://soundcloud.com/user-528315086/ys-i-ii-chronicles-first-step-towards-wars",
              answer: "Ys I&II Chronicles - First Step Towards Wars",
            },
                      {
              url: "https://soundcloud.com/pinky-orellana/sen-no-kiseki-iv-ost-burning",
              answer: "Sen no Kiseki IV - Burning Throb",
            },
                                                                        {
              url: "https://soundcloud.com/user-790251991/yesterday-in-etania?in=user-790251991/sets/ys-viii-lacrimosa-of-dana-ost",
              answer: "Ys VIII Lacrimosa of DANA - Yesterday in Etania",
            },
                                                                        {
              url: "https://soundcloud.com/okaysongs/dont-be-defeated-by-a-friend-trails-of-cold-steel-ost",
              answer: "Sen no Kiseki - Don't Be Defeated By A Friend!",
            },
                                                                        {
              url: "https://soundcloud.com/user-945662904/brave-steel?in=user-945662904/sets/sen-no-kiseki-iii-trails-of",
              answer: "Sen no Kiseki III - Brave Steel",
            },
                      {
              url: "https://soundcloud.com/valkyriae/ys-oath-in-felghana-dear-my",
              answer: "Ys: The Oath in Felghana - Dear My Brother",
            },
                                                                                  {
              url: "https://soundcloud.com/brolaire_of_asstora/the-false-god-of-causality-ys-memories-of-celceta",
              answer: "Ys: Foliage Ocean in Celceta - The False God of Causality",
            },
                                                                        {
              url: "https://soundcloud.com/okaysongs/tie-a-link-of-arcus-trails-of-cold-steel-ost?in=okaysongs/sets/trails-of-cold-steel-ost",
              answer: "Sen no Kiseki - Tie A Link Of ARCUS!",
            },
                                                                        {
              url: "https://soundcloud.com/user-790251991/next-step-toward-the-unknown?in=user-790251991/sets/ys-viii-lacrimosa-of-dana-ost",
              answer: "Ys VIII Lacrimosa of DANA - Next Step Towards the Unknown",
            },
                      {
              url: "https://soundcloud.com/pinky-orellana/sen-no-kiseki-iv-ost-mighty?in=pinky-orellana/sets/sen-no-kiseki-iv-ost-disc-1",
              answer: "Sen no Kiseki IV - Mighty Urge",
            },
                                          {
              url: "https://soundcloud.com/biscoto-theo/ys-ix-02-norse-wind?in=biscoto-theo/sets/ys-ix-monstrum-nox-chains-and-chansons",
              answer: "Ys IX Monstrum NOX - Norse Wind",
            },
                                          {
              url: "https://soundcloud.com/biscoto-theo/ys-ix-04-cloaca-maxima?in=biscoto-theo/sets/ys-ix-monstrum-nox-chains-and-chansons",
              answer: "Ys IX Monstrum NOX - Cloaca Maxima",
            },
                                {
              url: "https://soundcloud.com/bonfy257/ys-the-oath-in-felghana-ost-the-strongest-foe",
              answer: "Ys: The Oath in Felghana - The Strongest Foe",
            },
                                                                        {
              url: "https://soundcloud.com/mczhadow/the-legend-of-heroes-trails-23",
              answer: "Sora no Kiseki FC - Disappearing Star",
            },
                                          {
              url: "https://soundcloud.com/seishu-inukitsune/ys-vi-the-ark-of-napishtim-ost-mighty-obstacle",
              answer: "Ys VI: The Ark of Napishtim - Mighty Obstacle",
            },
                                                                        {
              url: "https://soundcloud.com/user-790251991/lost-in-green?in=user-790251991/sets/ys-viii-lacrimosa-of-dana-ost",
              answer: "Ys VIII Lacrimosa of DANA - Lost in Green",
            },
                                                                                  {
              url: "https://soundcloud.com/mczhadow/the-legend-of-heroes-trails-2",
              answer: "Sora no Kiseki FC - A Cat Relaxing in the Sun",
            },
                                                    {
              url: "https://soundcloud.com/s_m_m_m/ys-seven-innocent-primal-breaker",
              answer: "Ys Seven - Innocent Primal Breaker",
            },
                                                    {
              url: "https://soundcloud.com/user-876801860/ys-seven-ost-tia",
              answer: "Ys Seven - Tia",
            },
                                                                                            {
              url: "https://soundcloud.com/swaditsforroll20again/ys-the-oath-in-felghana-ost-1-12-a-searing-struggle",
              answer: "Ys: The Oath in Felghana - A Searing Struggle",
            },
                                                                                                      {
              url: "https://soundcloud.com/kohan-367011957/the-legend-of-heroes-trails-2",
              answer: "Sora no Kiseki the 3rd - Fighting Right On",
            },
                                                                                  {
              url: "https://soundcloud.com/user-790251991/dana?in=user-790251991/sets/ys-viii-lacrimosa-of-dana-ost",
              answer: "Ys VIII Lacrimosa of DANA - Dana",
            },
                      {
              url: "https://soundcloud.com/pinky-orellana/sen-no-kiseki-iv-ost-seductive?in=pinky-orellana/sets/sen-no-kiseki-iv-ost-disc-1",
              answer: "Sen no Kiseki IV - Seductive Shudder",
            },
                                                                                            {
              url: "https://soundcloud.com/user-947639095/ys-foliage-ocean-in-celceta-ost-adventurers-birth",
              answer: "Ys: Foliage Ocean in Celceta - Adventurer's Birth",
            },
                                                                                  {
              url: "https://soundcloud.com/user-790251991/gens-darmes?in=user-790251991/sets/ys-viii-lacrimosa-of-dana-ost",
              answer: "Ys VIII Lacrimosa of DANA - Gens D'Armes",
            },
                                                                                            {
              url: "https://soundcloud.com/swaddythecakes/the-merciless-savior-trails-in-the-sky-sc-ost",
              answer: "Sora no Kiseki SC - The Merciless Savior",
            },
                                                                                  {
              url: "https://soundcloud.com/user-790251991/overcome-the-rocky-path?in=user-790251991/sets/ys-viii-lacrimosa-of-dana-ost",
              answer: "Ys VIII Lacrimosa of DANA - Overcome the Rocky Path",
            },
                                {
              url: "https://soundcloud.com/user-282665864/ys-the-oath-in-felghana-ost-sealed-time",
              answer: "Ys: The Oath in Felghana - Sealed Time",
            },
                                                                                            {
              url: "https://soundcloud.com/the-anime-civilian/trails-in-the-sky-sc-silver",
              answer: "Sora no Kiseki SC - Silver Will, Golden Wings",
            },
                                          {
              url: "https://soundcloud.com/justin-the-gm/ys-vi-the-ark-of-napishtim-os-zemeth-sanctum",
              answer: "Ys VI: The Ark of Napishtim - Zemeth Sanctum",
            },
                                                    {
              url: "https://soundcloud.com/franco-fabian-rubio-gamboa/ys-origin-scarlet-tempest",
              answer: "Ys Origin Super Arrange Version - Scarlet Tempest",
            },
                                                                                                      {
              url: "https://soundcloud.com/user-430766509/formidable-enemy",
              answer: "Zero no Kiseki - Formidable Enemy (Super Arrange)",
            },
                                                                                                      {
              url: "https://soundcloud.com/zul-qadri-82184695/ys-foliage-ocean-in-celceta-1",
              answer: "Ys: Foliage Ocean in Celceta - Ancient Land",
            },
                                                                                  {
              url: "https://soundcloud.com/user-790251991/eroded-valley?in=user-790251991/sets/ys-viii-lacrimosa-of-dana-ost",
              answer: "Ys VIII Lacrimosa of DANA - Eroded Valley",
            },
                                                                                            {
              url: "https://soundcloud.com/mczhadow/the-legend-of-heroes-trails-2",
              answer: "Sora no Kiseki FC - A Cat Relaxing in the Sun",
                                          ...
                                          {
              url: "https://soundcloud.com/lastxcution/bi4r5vmfoxtf",
              answer: "Ys VI: The Ark of Napishtim - Quatera Woods",
            },
                                                                                                      {
              url: "https://soundcloud.com/the-anime-civilian/trails-in-the-sky-sc-back-to",
              answer: "Sora no Kiseki SC - Back to Our Friends",
            },
                                {
              url: "https://soundcloud.com/guillaume-cousin-8/ys-the-oath-in-felghana-a-premonition-styx",
              answer: "Ys: The Oath in Felghana - A Premonition =Styx=",
            },
                                                                                  {
              url: "https://soundcloud.com/user-790251991/crimson-fighter?in=user-790251991/sets/ys-viii-lacrimosa-of-dana-ost",
              answer: "Ys VIII Lacrimosa of DANA - Crimson Fighter",
            },
                                                                                                      {
              url: "https://soundcloud.com/user-942232914/trails-in-the-sky-sc-ost-the-enforcers-super-arrange-version",
              answer: "Sora no Kiseki SC - The Enforcers (Super Arrange)",
            },
                                                    {
              url: "https://soundcloud.com/excalibah-1/ys-origin-termination",
              answer: "Ys Origin - Termination",
            },
                                                                                            {
              url: "https://soundcloud.com/zul-qadri-82184695/ys-foliage-ocean-in-celceta-6",
              answer: "Ys: Foliage Ocean in Celceta - The Dawn of Ys",
            },
                                                                                                      {
              url: "https://soundcloud.com/the-anime-civilian/trails-in-the-sky-sc-i-swear",
              answer: "Sora no Kiseki SC - I Swear",
            },
                                          {
              url: "https://soundcloud.com/ja-boi-aidan/the-ruined-city-kishgal-from-ys-vi-the-ark-of-napishtim",
              answer: "Ys VI: The Ark of Napishtim - The Ruined City of Kishgal",
            },
                                          {
              url: "https://soundcloud.com/silver-183047884/ys-the-oath-in-felghana-ost-be-careful",
              answer: "Ys: The Oath in Felghana - Be Careful",
            },
                      {
              url: "https://soundcloud.com/okaysongs/belief-trails-of-cold-steel-ost",
              answer: "Sen no Kiseki - Belief",
            },
                                                    {
              url: "https://soundcloud.com/excalibah-1/ys-origin-overdrive",
              answer: "Ys Origin - Overdrive",
  
            },
                                                                                  {
              url: "https://soundcloud.com/user-790251991/a-footprint-in-the-wet-sand?in=user-790251991/sets/ys-viii-lacrimosa-of-dana-ost",
              answer: "Ys VIII Lacrimosa of DANA - A Footprint in the Wet Sand",
            },
                                                                                            {
              url: "https://soundcloud.com/kohan-367011957/the-legend-of-heroes-trails-1",
              answer: "Sora no Kiseki the 3rd - Determination of Fight",
            },
                                                                                  {
              url: "https://soundcloud.com/user-790251991/hope-alive?in=user-790251991/sets/ys-viii-lacrimosa-of-dana-ost",
              answer: "Ys VIII Lacrimosa of DANA - Hope Alive",
            },
                                                                                            {
              url: "https://soundcloud.com/mczhadow/the-legend-of-heroes-trails-38",
              answer: "Sora no Kiseki FC - The Byway of Departure",
            },
                                                                                            {
              url: "https://soundcloud.com/zul-qadri-82184695/ys-foliage-ocean-in-celceta",
              answer: "Ys: Foliage Ocean in Celceta - The Foliage Ocean in Celceta",
            },
                                          {
              url: "https://soundcloud.com/silver-183047884/ys-the-oath-in-felghana-ost-the-theme-of-chester",
              answer: "Ys: The Oath in Felghana - The Theme of Chester",
            },
                                {
              url: "https://soundcloud.com/okaysongs/to-become-the-foundation-of-an-era-trails-of-cold-steel-ost?in=okaysongs/sets/trails-of-cold-steel-ost",
              answer: "Sen no Kiseki - To Become The Foundation Of An Era",
            },
                                                    {
              url: "https://soundcloud.com/excalibah-1/ys-origin-my-lord-our-brave",
              answer: "Ys Origin - My Lord, Our Brave",
            },
      ...
      return {
        c() {
          (t = w("meta")),
            ...
            (C = x()),
            H && H.c(),
            (An.title = "Falcom Heardle"),
            M(t, "name", "description"),
            M(
              t,
              "content",
              "Guess the Falcom song from the intro in as few tries as possible! "
            ),
